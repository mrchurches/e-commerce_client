  ...
  return (
    <div>
            ...
            <div class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="px-5 pb-5">
                ...
                <div class="flex justify-between items-center">
                  <span class="text-3xl font-bold text-gray-900 dark:text-white">{Math.random() * 100}</span>
...

      {
        ...
        <div class="card">
          <Link to={`/detail/${id}`}>
            <img class="card-img-top" style={{width: '18rem', height: '10rem'}} src={img} alt="product image" />
          </Link>
          <div class="card-body">
            <Link to={`/detail/${id}`}>
            ...
            {/*<div class="ratings">
              ...
              <svg aria-hidden="true" class="fa fa-star rating-color" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Third star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
