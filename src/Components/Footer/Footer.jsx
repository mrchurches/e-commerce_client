...
export default function About() {
    ...
    return (
        <nav class="" className={styles.footer} style={{ display: display, borderRadius: '0' }}>
            {location.pathname === "/admin" ? <div></div> :
                <div class="nav ms-auto flex-sm-column flex-md-row w-100 justify-content-center p-5" >
                    <div class="p-2 ">
                        ...
                        <h6 class="text-light">videogamesmarket@mailing.com</h6>
                    </div>
                    <div class="p-2">
                        ...
                        <h6 class="text-light">(0800) 333 4888</h6>
                    </div>
                    <div class="p-2">
                        ...
                        <h6 class="text-light">Scalabrini Ortiz 1822
